...
public interface MerchantCategoryCodes {
    ...
    MastercardTransactionCategoryCode TCC_U_IFC = MastercardTransactionCategoryCode.TCC_U_CARDHOLDER_ACTIVATED_TERMINAL_IFC;
    ...
    enum Iso18245MerchantCategoryCode {
        ...
        public static final String AIRLINE_MCC_MUST_FOLLOW_THE_FORM_BRAND_NAME_VISA_ABBREVIATION_MC_ABBREVIATION_TSYS_ABRREVIATION = "Airline MCC must follow the form \"brand name[;;##VISA##abbreviation][;;##MC##abbreviation][;;##TSYS##abrreviation])\"";
         ...
         */
        public String getVisaBrandAbbreviation() {
            return visaBrandAbbreviation;
        }

        /**
         * Returns the Mastercard required airline brand abbreviation
         */
        public String getMastercardBrandAbbreviation() {
            return mastercardBrandAbbreviation;
        }

        /**
         * Returns the TSYS (Germany) required airline brand abbreviation
         */
        public String getTsysBrandAbbreviation() {
            return tsysBrandAbbreviation;
        }
        ...
        public class MerchantCategoryCode implements Serializable {
             ...
             */
            private final Iso18245MerchantCategoryCode mcc;
             ...
             */
            public Iso18245MerchantCategoryCode getMCC() {
                return mcc;
            }
        ...
        private interface IListType {
            MerchantCategoryList getMCCList(Comparator<ICategory> listCriterion, Comparator<MerchantCategoryCode> mccCriterion);

            String getMCCListAsJSON(Comparator<ICategory> listCriterion, Comparator<MerchantCategoryCode> mccCriterion);
        }
        ...
        private interface ICategoryList extends ICategory {
            ICategory get(ITaxonomy taxonomy);

            void addCategory(ICategory category);

            void sortList(Comparator<ICategory> listCriterion, Comparator<MerchantCategoryCode> mccCriterion);
        }
        ...
        private static class Container implements ITaxonomy {
            ...
            @Override
            public String getDescription() {
                return Messages.getString("IMerchantCategoryCodes.ContainerTaxonomy.Root");
            } //$NON-NLS-1$
         ...
         */
        private class CategoryList extends ArrayList<ICategory> implements ICategoryList {
            ...
            public void addMCC(ITaxonomy taxonomy, Iso18245MerchantCategoryCode mcc) {
                ...
                if (category == null) {
                    super.add(createCategory(taxonomy));
                } else {
             ...
             */
            protected ICategory createCategory(ITaxonomy taxonomy) {
                return new Category(taxonomy);
            }
            ...
            public ICategory get(ITaxonomy taxonomy) {
                int ccode = taxonomy.getCode();
                for (ICategory category : this) {
                    if (category.getCode() == ccode) return category;
                }
                return null;
            }
         ...
         */
        private class ListCategoryList extends CategoryList {
            ...
            @Override
            protected ICategory createCategory(ITaxonomy taxonomy) {
                return new CategoryList(taxonomy);
            }
        ...
        private class ThomsonReutersNestedList extends NestedList {
             ...
             */
            private final ListCategoryList root = new ListCategoryList(new Container());

            /**
             * Fulfils NestedList contract
             */
            @Override
            protected ICategoryList getRoot() {
                return root;
            }
        ...
        private class SchemeNestedList extends NestedList {
             ...
             */
            private final CategoryList root = new CategoryList(new Container());
